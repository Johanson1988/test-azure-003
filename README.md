...
Try [Nexty.dev today](https://nexty.dev?utm_source=github-test-azure-003)
---

[<img src="/public/try-nexty.webp">](https://nexty.dev?utm_source=github-test-azure-003)
...
- [👉 Source Code](https://github.com/weijunext/test-azure-003)
...
```bash
git clone https://github.com/weijunext/test-azure-003.git
cd test-azure-003
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/weijunext/test-azure-003&project-name=&repository-name=test-azure-003&demo-title=NextjsStarter&demo-description=Nextjs%2015%20starter.&demo-url=https://nextforge.dev&demo-image=https://nextforge.dev/og.png)
